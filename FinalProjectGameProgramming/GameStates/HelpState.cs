...
namespace FinalProjectGameProgramming.GameStates
{
    internal class HelpState : IGameState
    {
        ...
        public HelpState(GraphicsDeviceManager graphics, ContentManager content, GameStateHandler gameStateHandler, GraphicsDevice graphicsDevice, SpriteFont font)
        {
            _graphics = graphics;
            _content = content;
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            string information = $"How to play game?";
